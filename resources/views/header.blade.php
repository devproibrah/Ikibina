...
<head>
    ...
    @if( session('status')=="123")
    {{--session('status')--}}
{{ request()->session()->put('status2','11111') }}  
@elseif(session()->get('status2')=="11111")
{{-- request()->session()->get('status2') --}}
{{ request()->session()->put('status2','11111') }}
@else

<form name="logounForm" action="{{url('/')}}" method="get">

</form>
<script type="text/javascript">
document.forms['logounForm'].submit();
</script>
@endif
</head>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <ul class="social-network">
                            ...
                            <li> <a class="waves-effect waves-dark" class="nav-link" href="{{url('/')}}"> 
                            sohoka
                            </a></li>
                        </ul>
                    </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/Home')}}">ahabanza
                                <span class="sr-only">(current)</span>
                            </a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/AdminDashboard')}}">ahobibera</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="#">baza</a>
                        </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Ubusabe</a>
                        </li>
                        @endif
